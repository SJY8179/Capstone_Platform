...
/* Root/Trigger/Portal/Close — 그대로 래핑 */
function Dialog(
  ...
  <DialogPortal data-slot="dialog-portal">
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "gap-4 rounded-lg border bg-background p-6 shadow-lg duration-200 sm:max-w-lg",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
...
<<<<<<< HEAD
/* forwardRef 적용: Title/Description (a11y) */
